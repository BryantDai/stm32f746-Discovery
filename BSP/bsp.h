...
#define  BSP_INT_ID_SDMMC1                                49u   /* SDMMC1 global Interrupt                              */
...
#define  BSP_INT_ID_UART7                                 82u   /* UART7 global interrupt                               */
#define  BSP_INT_ID_UART8                                 83u   /* UART8 global interrupt                               */
#define  BSP_INT_ID_SPI4                                  84u   /* SPI4 global interrupt                                */
#define  BSP_INT_ID_SPI5                                  85u   /* SPI5 global interrupt                                */
#define  BSP_INT_ID_SPI6                                  86u   /* SPI6 global interrupt                                */
#define  BSP_INT_ID_SAI1                                  87u   /* SAI1 global interrupt                                */
#define  BSP_INT_ID_LCD_TFT                               88u   /* LCD-TFT gloabl interrupt                             */
#define  BSP_INT_ID_LCD_TFT_ERR                           89u   /* LCD-TFT gloabl error interrupt                       */
#define  BSP_INT_ID_DMA2D                                 90u   /* DMA2D gloabl interrupt                               */
#define  BSP_INT_ID_SAI2                                  91u   /* SA12 global interrupt                                */
#define  BSP_INT_ID_QUAD_SPI                              92u   /* QuadSPI global interrupt                             */
#define  BSP_INT_ID_LP_TIMER1                             93u   /* LP timer1 global interrupt                           */
#define  BSP_INT_ID_HDMI_CEC                              94u   /* HDMI-CEC global interrupt                            */
#define  BSP_INT_ID_I2C4_EV                               95u   /* I2C4 event interrupt                                 */
#define  BSP_INT_ID_I2C4_ER                               96u   /* I2C4 error interrupt                                 */
#define  BSP_INT_ID_SPDIFRX                               97u   /* SPDIFRX global interrupt                             */

#define  BSP_INT_SRC_NBR                                  98u
...
#define  BSP_PERIPH_ID_AXI                                13u
#define  BSP_PERIPH_ID_FLITF                              15u
#define  BSP_PERIPH_ID_SRAM1                              16u
#define  BSP_PERIPH_ID_SRAM2                              17u
...
#define  BSP_PERIPH_ID_SDMMC1                            139u
...
#define  BSP_PERIPH_ID_SAI2                              151u
...
void        BSP_IntHandlerSDMMC1            (void);
...
void        BSP_IntHandlerLCD_TFT           (void);
void        BSP_IntHandlerLCD_TFT_ERR       (void);
void        BSP_IntHandlerDMA2D             (void);
void        BSP_IntHandlerSAI2              (void);
void        BSP_IntHandlerQUAD_SPI          (void);
void        BSP_IntHandlerLP_TIMER1         (void);
void        BSP_IntHandlerHDMI_CEC          (void);
void        BSP_IntHandlerI2C4_EV           (void);
void        BSP_IntHandlerI2C4_ER           (void);
void        BSP_IntHandlerSPDIFRX           (void);
