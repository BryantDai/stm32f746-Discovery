...
void  BSP_IntHandlerSDMMC1             (void)  { BSP_IntHandler(BSP_INT_ID_SDMMC1);              }
...
void  BSP_IntHandlerLCD_TFT            (void)  { BSP_IntHandler(BSP_INT_ID_LCD_TFT);             }
void  BSP_IntHandlerLCD_TFT_ERR        (void)  { BSP_IntHandler(BSP_INT_ID_LCD_TFT_ERR);         }
void  BSP_IntHandlerDMA2D              (void)  { BSP_IntHandler(BSP_INT_ID_DMA2D);               }
void  BSP_IntHandlerSAI2               (void)  { BSP_IntHandler(BSP_INT_ID_SAI2);                }
void  BSP_IntHandlerQUAD_SPI           (void)  { BSP_IntHandler(BSP_INT_ID_QUAD_SPI);            }
void  BSP_IntHandlerLP_TIMER1          (void)  { BSP_IntHandler(BSP_INT_ID_LP_TIMER1);           }
void  BSP_IntHandlerHDMI_CEC           (void)  { BSP_IntHandler(BSP_INT_ID_HDMI_CEC);            }
void  BSP_IntHandlerI2C4_EV            (void)  { BSP_IntHandler(BSP_INT_ID_I2C4_EV);             }
void  BSP_IntHandlerI2C4_ER            (void)  { BSP_IntHandler(BSP_INT_ID_I2C4_ER);             }
void  BSP_IntHandlerSPDIFRX            (void)  { BSP_IntHandler(BSP_INT_ID_SPDIFRX);             }
