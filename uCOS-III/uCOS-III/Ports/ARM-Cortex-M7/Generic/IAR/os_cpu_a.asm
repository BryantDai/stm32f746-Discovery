...
OSStartHighRdy
    ...
    MOV32   R0, NVIC_SYSPRI14                                   ; Set the PendSV exception priority(The lowest priority)
...
OS_CPU_PendSVHandler
    CPSID   I                                                   ; Prevent interruption during context switch(equivalent to writing a 1 into PRIMASK)
    MRS     R0, PSP                                             ; PSP is process stack pointer(Read the content of PSP register to R0)
